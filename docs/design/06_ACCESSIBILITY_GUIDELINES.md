...
| 顧客G | 認知障害/学習障害 | ふりがな・平易な言葉・構造化 |
| 顧客H | 聴覚障害（ろう者） | 視覚的フィードバック・テキスト通知 |
| 顧客I | 高齢者（弱視＋震え） | 大タッチターゲット(44px)・UDフォント |
