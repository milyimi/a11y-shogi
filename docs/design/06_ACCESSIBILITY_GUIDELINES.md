...
障害者ユーザー17種類＋AIペルソナ（7種類）計24種類で品質検証:
...
| 顧客P | 片麻痺 | Tab+Enter+Escape・Space対応 |
...
| ペルソナ | カテゴリ | 検証内容 |
|---|---|---|
| 棋士AI | 専門家 | 駒配置・移動ルール・将棋用語正確性 |
| WebデザイナーAI | 専門家 | レイアウト・レスポンシブ・配色一貫性 |
| UXリサーチャーAI | 専門家 | ニールセン10原則・ヒューリスティック評価 |
| 教育者AI | 専門家 | 特別支援学校教諭の観点・多様な障がい対応 |
| 加齢による見えにくさAI | 年齢層 | デジタル不慣れ（72歳）・視認性 |
| 子供・初心者AI | 初心者 | 小学生（12歳）・将棋初心者・直感性 |
| モバイルユーザーAI | 環境 | スマートフォン・レスポンシブ・通勤ユーザー |
