 ...
 * 顧客G: 発達特性/学習障害（読みやすさ・わかりやすさ重視） — ルール知らない
 * 顧客H: 聴覚障害者（ろう者） — ルール知っている
 * 顧客I: 加齢による見えにくさのある人（70代・弱視＋上肢の震え） — ルール知っている
...
(async () => {
    ...
    // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    // 顧客I: 加齢による見えにくさのある人（70代・弱視＋震え） — ルール知っている
    // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    console.log('\n═══ 顧客I: 加齢による見えにくさのある人（70代・弱視＋震え） ═══\n');
    {
        const page = await browser.newPage();
        await page.setViewport({ width: 1024, height: 768 });
